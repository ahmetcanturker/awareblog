...
export const applicationMuiDarkTheme = createMuiTheme({
    palette: {
        type: 'dark',
        common: {
            black: '#000',
...
export const applicationMuiLightTheme = createMuiTheme({
    palette: {
        type: 'light',
        common: {
            black: '#000',
...
let muiComTheme: any = {
    ...
    "palette": {
        ...
        "secondary": {
            "main": "#f48fb1", "light": "rgb(246, 165, 192)", "dark": "rgb(170, 100, 123)", "contrastText": "rgba(0, 0, 0, 0.87)"
        },
